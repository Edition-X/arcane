...
def artifact_repo_with_runs(artifact_repo):
    ...
    runs = [
        ...
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-1",
         "title": "CI #1 [failure] on main", "url": None, "project": "proj",
         "created_at": "2026-03-19T10:00:00+00:00",
         "raw_data": {"conclusion": "failure", "head_sha": "aaa", "head_branch": "main",
                       "name": "CI", "run_attempt": 1, "event": "push"}},
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-2",
         "title": "CI #2 [success] on main", "url": None, "project": "proj",
         "created_at": "2026-03-19T10:05:00+00:00",
         "raw_data": {"conclusion": "success", "head_sha": "aaa", "head_branch": "main",
                       "name": "CI", "run_attempt": 2, "event": "push"}},
        # Different commit, consistent failure → NOT a flake
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-3",
         "title": "CI #3 [failure] on feature", "url": None, "project": "proj",
         "created_at": "2026-03-20T10:00:00+00:00",
         "raw_data": {"conclusion": "failure", "head_sha": "bbb", "head_branch": "feature",
                       "name": "CI", "run_attempt": 1, "event": "push"}},
        # Another flake pair on a different commit
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-4",
         "title": "CI #4 [failure] on main", "url": None, "project": "proj",
         "created_at": "2026-03-20T12:00:00+00:00",
         "raw_data": {"conclusion": "failure", "head_sha": "ccc", "head_branch": "main",
                       "name": "CI", "run_attempt": 1, "event": "push"}},
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-5",
         "title": "CI #5 [success] on main", "url": None, "project": "proj",
         "created_at": "2026-03-20T12:05:00+00:00",
         "raw_data": {"conclusion": "success", "head_sha": "ccc", "head_branch": "main",
                       "name": "CI", "run_attempt": 2, "event": "push"}},
        # Clean success
        {"id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-6",
         "title": "CI #6 [success] on main", "url": None, "project": "proj",
         "created_at": "2026-03-21T08:00:00+00:00",
         "raw_data": {"conclusion": "success", "head_sha": "ddd", "head_branch": "main",
                       "name": "CI", "run_attempt": 1, "event": "push"}},
    ]
    for run in runs:
...
class TestCIFlakeDetector:
    ...
    def test_consistent_failures_not_flagged(self, artifact_repo):
        ...
        artifact_repo.insert({
            "id": str(uuid.uuid4()), "artifact_type": "ci_run", "external_id": "run-solo",
            "title": "CI [failure]", "url": None, "project": "proj",
            "created_at": "2026-03-21T10:00:00+00:00",
            "raw_data": {"conclusion": "failure", "head_sha": "xxx", "head_branch": "main",
                          "name": "CI", "run_attempt": 1, "event": "push"},
        })
        detector = CIFlakeDetector(artifact_repo=artifact_repo)
        insights = detector.analyze(project="proj")
